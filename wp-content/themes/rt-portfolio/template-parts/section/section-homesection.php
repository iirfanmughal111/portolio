                        ...
                        while ($loop->have_posts()) : $loop->the_post(); ?> 
                            ...
                            <div class="personal-description">
                                ...
                                <div class="entry-content">
                                    <p>
                                        <?php
                                        $read_more = '<a href="'.esc_url( get_permalink() ).'">'.esc_html__( '...Read More', 'rt-portfolio').'</a>';
                                            echo wp_kses_post( wp_trim_words( get_the_content(), 40, $read_more ) );
                                        ?>
                                    </p>
                    ...
                    if ($progress_secton ): 
                        ...
                        ?>
                            <div class="individual-skills">
                                ...
                                <div class="skills-value"><?php echo absint( $progess_number );?><?php echo esc_html( $progess_icon );?></div>
