...
function rt_portfolio_scripts() {
	...
	//carousel
	wp_enqueue_script( 'owl-carousel', get_template_directory_uri() . '/assets/js/owl.carousel.js', array('jquery'), 'v2.2.1', true );

	//Counterup
	wp_enqueue_script( 'counterup', get_template_directory_uri() . '/assets/js/jquery.counterup.min.js', array('jquery'), 'v2.2.1', true );

	//nice scroll
	wp_enqueue_script( 'nicescroll', get_template_directory_uri() . '/assets/js/jquery.nicescroll.js', array('jquery'), 'v2.2.1', true );

	//waypoints
	wp_enqueue_script( 'waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', array('jquery'), '4.0.1', true );

	//Full Page
	wp_enqueue_script( 'fullpage', get_template_directory_uri() . '/assets/js/jquery.fullpage.min.js', array('jquery'), '2.9.7', true );

	//jquery-meanmenu
	wp_enqueue_script( 'meanmenu', get_template_directory_uri() . '/assets/js/jquery.meanmenu.js', array('jquery'), 'v2.0.8', true );

    wp_enqueue_script( 'rt-portfolio-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

    wp_enqueue_script( 'rt-portfolio-keyboard-navigation', get_template_directory_uri() . '/assets/js/keyboard-navigation.js', array(), '20151215', true );
